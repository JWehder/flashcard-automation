    ...
    return (
        <div>
            <>
                ...
                <button className="rounded-full bg-blue-500 hover:bg-blue-700 mx-4 my-3 p-1.5 text-sm text-white border-2" onClick={() => setShowForm(true)}>
                    create new set +
                </button>
            </>
            { showForm ?
                <div className="flex justify-center mt-4">
                    <form className="flex" onSubmit={handleSubmit}>
                        ...
                        className="p-0.25 text-base border-b-2 border-b-blue-500/50 transition-all duration-0.2 focus:outline-none focus:border-b-blue-500 my-1 text-gray-500 mx-2"
                        >
                        </input>
