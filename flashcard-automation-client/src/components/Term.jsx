...
export default function Term({ term, definition, id }) {
    ...
    // one variable needs to determine whether or not these icons and inputs are disabled
    ...
    return (
        <div className="border-2 p-[15px] w-[600px] my-[5px] rounded-lg">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" name="delete" className="w-6 h-6 stroke-blue-500/50 cursor-pointer hover:stroke-blue-500" onClick={handleDelete}>
